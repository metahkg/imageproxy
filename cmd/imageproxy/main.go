...
var allowOptions = flag.String("allowOptions", "", "semi-colon separated list of allowed options")
...
func main() {
    ...
    if *allowOptions != "" {
		...
		for i, v := range p.AllowOptions {
			p.AllowOptions[i] = imageproxy.ParseOptions(v).String()
		}
    }
	if *allowSizes != "" {
